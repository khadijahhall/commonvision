...
<html lang="en">
    ...
    <head>
        ...
        <title>Bootstrap Login Form Temp\</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Common Vision</strong> Alumni Portal Registration</h1>
                            <div class="description">
                            	<p>
	                            	Welcome to the Common Vision Alumni Portal! 
	                            	Check out <a href="http://www.commonvision.org/volunteer/"><strong>Common Vision</strong></a>, and sign up for another tour!
                            	</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="register" method="POST" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="password" name="mypassword" placeholder="Confirm Password..." class="form-password form-control" id="form-password">
			                        </div>
